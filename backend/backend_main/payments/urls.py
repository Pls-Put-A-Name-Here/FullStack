...
from .views import initiate_payment, payment_callback_view, payment_success_view, payment_failure_view

urlpatterns = [
    path('payments/initiate/<uuid:order_id>/', initiate_payment, name='initiate_payment'),
