...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Address',
            fields=[
                ('address_id', models.AutoField(db_column='adrIdpk', primary_key=True, serialize=False)),
                ('address_location', models.CharField(db_column='adrLocation', max_length=255)),
                ('digital_address', models.CharField(db_column='adrDigitalAddress', max_length=255)),
                ('house_address', models.CharField(db_column='adrHouseAddress', max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('user_id', models.AutoField(db_column='usrIdpk', primary_key=True, serialize=False)),
                ('user_name', models.CharField(db_column='usrName', max_length=50)),
                ('user_password', models.CharField(db_column='usrPassword', max_length=50)),
                ('user_email', models.CharField(db_column='usrEmail', max_length=50)),
                ('user_date_of_birth', models.DateField(db_column='usrDoB')),
                ('user_phone_number', models.CharField(db_column='usrPhoneNumber', max_length=50)),
            ],
            options={
                'db_table': 'tblUsers',
                'managed': False,
